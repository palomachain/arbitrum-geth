...
import (
	...
	"github.com/palomachain/arbitrum-geth/crypto/signify"
	"github.com/palomachain/arbitrum-geth/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/palomachain/arbitrum-geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/palomachain/arbitrum-geth/internal/version.gitDate="+env.Date)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/palomachain/arbitrum-geth/core/rawdb", "github.com/palomachain/arbitrum-geth/ethdb/leveldb"},
		{"github.com/palomachain/arbitrum-geth/core/rawdb", "github.com/palomachain/arbitrum-geth/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
